import { DEFAULT_ROOF_ASSEMBLY_ID, type RoofAssemblyId } from '@/building/model/ids'
...
export const createDefaultRoofAssemblies = (): RoofAssemblyConfig[] => {
  ...
  return [monolithicAssembly, purlinAssembly]
}
