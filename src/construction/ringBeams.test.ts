...
import { createVec2, createLength, polygonIsClockwise } from '@/types/geometry'
import type { PerimeterCorner, Perimeter, PerimeterId } from '@/model'
import type { MaterialId, ResolveMaterialFunction } from './material'
import { type ConstructionElementId } from './base'
import * as base from './base'

vi.mock('./base', async () => {
  const original = await vi.importActual('./base')
